...
def load_ortho_dict(n):
    basis_cache_path = os.path.join(os.path.dirname(__file__), 'orthogonal_basis')
    os.makedirs(basis_cache_path, exist_ok=True)
    path = os.path.join(basis_cache_path, f'{n:09}.ckpt')
